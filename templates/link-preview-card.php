...
<div class="h-full rounded-lg shadow-md wp-block-item">
    ...
    <div class="bottom-0 px-8 text-right">
        <a href="<?php echo $attributes['link_url'] ?>" class="no-underline" target="<?php $attributes['opens_in_new_tab'] == true ? '' : '_blank' ?>">
            <button type=" button" class="inline-flex items-center px-4 py-2 mt-2 mb-8 space-x-4 font-medium text-white transition-all border border-transparent rounded-md shadow-sm bg-secondary hover:brightness-105 focus:outline-none">
                <?php echo ($attributes['link_text'] != null ? $attributes['link_text'] : 'Read more') ?>
